<template>
  <div>
    <div class="grid grid-nogutter text-indigo-800">
      <div
        class="
          col-12
          md:col-6
      ...
      >
        <section>
          ...
          <p class="mt-0 mb-2 text-bluegray-900 text-lg line-height-3">
            {{ main["Quote"] }}
          </p>
          <Divider> </Divider>
          <div class="template">
            ...
            <div class="template">
              <label
                for="addess"
                class="block col text-xl text-indigo-900 font-bold mr-2 p-0"
      ...
      <div
        class="
          ...
          lg:col-6
          align-self-auto
          md:pl-0 md:py-8 md:align-content-start md:justify-content-start
          align-self-center
          flex
          align-items-center
          justify-content-center
